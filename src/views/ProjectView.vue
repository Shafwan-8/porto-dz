...
<template>
  <section class="min-h-screen flex flex-col items-center justify-center py-16 px-8 gap-12 mt-10 w-full">
    ...
    <div class="text-center space-y-3">
      <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-[#1a1a1a] m-0">My Projects</h1>
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 w-full max-w-4xl mx-auto">
      ...
      <RouterLink to="/project/skins" class="group flex flex-col items-center justify-center bg-[#e5e7eb] hover:bg-[#d1d5db] transition-all duration-300 p-16 md:p-20 text-[#1a1a1a]">
        <!-- Blocky Shirt Icon -->
